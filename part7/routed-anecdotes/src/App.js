    ...
    return (
        <div>
            ...
            <form onSubmit={handleSubmit}>
                <div>
                    content
                    <input name='content' type='text' value={content.value} onChange={content.onChange}/>
                </div>
                <div>
                    author
                    <input name='author' type='text' value={author.value} onChange={author.onChange}/>
                </div>
                <div>
                    url for more info
                    <input name='info' type='text' value={info.value} onChange={info.onChange}/>
                </div>
...
const Anecdote = ({anecdote}) => {
    if (!anecdote)
        return (
            <div>
                <h1 style={{color: 'red'}}>ERROR Anecdote not found</h1>
            </div>
        )
